...
<div class="row">
    ...
    <div class="col-md-12 head">
        <div class="float-right">
            <a href="javascript:void(0);" class="btn btn-success" onclick="formToggle('importFrm');"><i class="plus"></i><h1 style="color:crimson;"> IMPORT<h1></a>
        </div>
    </div>
    ...
    <table class="table table-striped table-bordered" style="border: 1px solid black;border-collapse: collapse;width: 80%;">
        <thead class="thead-dark">
            <tr>
                <th style="border: 1px solid black;border-collapse: collapse;background-color: #C0C0C0;">#ID</th>
                <th style="border: 1px solid black;border-collapse: collapse;background-color: #C0C0C0;">Name</th>
                <th style="border: 1px solid black;border-collapse: collapse;background-color: #C0C0C0;">Email</th>
                <th style="border: 1px solid black;border-collapse: collapse;background-color: #C0C0C0;">Phone</th>
                <th style="border: 1px solid black;border-collapse: collapse;background-color: #C0C0C0;">Status</th>
            </tr>
        </thead>
        <tbody>
        </center>
        ...
        ?>
            <tr>
                ...
                <td style="border: 1px solid black;border-collapse: collapse;"><?php echo $row['phone']; ?></td>
...
<center><button onclick="goBack()" style="margin-top: 13px;">Go Back</button>
